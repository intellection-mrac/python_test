...
folder_path = '/home/intellection/Intellection/local/python_tests/tile_analyser_openCV/in/'  # Update with your folder path
...
def save_image():
    ...
    output_path = os.path.join(processed_folder, f'processed_image_{current_image_index + 1}.jpg')
    cv2.imwrite(output_path, processed_image)
    print(f"Processed image saved as '{output_path}'.")

    # Proceed to next image in the folder
