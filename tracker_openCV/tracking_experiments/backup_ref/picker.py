...
def pick_color(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        if color_picker_state == 0:
            ...
            cv2.putText(frame, "Color 1 Selected. Now pick Color 2.", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 255), 2)
            ...
            cv2.putText(frame, "Both Colors Selected! Starting Tracking...", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 255), 2)
...
def track_objects(camera_index=CAMERA_INDEX):
    ...
    while True:
        ...
        if color_picker_state < 2:
            cv2.putText(frame, COLOR_PICKER_INSTRUCTION, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 255), 2)
