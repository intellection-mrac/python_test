...
COLOR_PICKER_INSTRUCTION = "Click to select Color 1. Then, click for Color 2."
...
def track_objects(camera_index=CAMERA_INDEX):
    ...
    while True:
        ...
        if color_picker_state < 2:
            ...
            cv2.putText(frame, COLOR_PICKER_INSTRUCTION, (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)
