...
def display_materials(stdscr, materials, selected_row):
    stdscr.clear()
...
def display_buttons(stdscr, selected_button):
    buttons = ["Select", "New", "Edit", "Remove", "Export CSV", "Bill", "Quit"]
    stdscr.addstr(20, 0, "--------------------------------------------------")
...
def main(stdscr):
    ...
    while True:
        display_materials(stdscr, materials, selected_row)
        ...
        elif key == curses.KEY_RIGHT and selected_button < 6:
            selected_button += 1
